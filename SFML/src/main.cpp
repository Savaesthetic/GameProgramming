...
int main(int argc, char* argv[])
{
    ...
    {
        // if we can't load the font, print an error to the error console and continue on with default font
        std::cerr << "Could not load font! Continuing with default font.\n";
    }
